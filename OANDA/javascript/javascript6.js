    ...
    var ccJs = function(options) {
        ...
        function parseQueryStringToParameters(doc) {
            ...
            if (mode == "BCP") {
                ...
                if ("true" == qs["runOptimusOnly"]) runOptimusOnly = true;
                delete qs["ns"];
                delete qs["autobcp"];
                delete qs["pre"];
                delete qs["cmpwait"];
        ...
        function setBCPDomainPrefix(prefix) {
            ...
            else if (typeof console != "undefined") console.log(prefix + " is not valid")
        }
        ...
        function baseURL(is_pv, version, domainArg, sepArg, delimArg) {
            ...
            var domainToUse;
            if (typeof domainArg != "undefined" && domainArg !=
                null) domainToUse = domainArg;
            ...
            if (cmp["daisybit"] != null) url += delimToUse + "db\x3d" + cmp["daisybit"];
        ...
        function getCookie(cookieName) {
            ...
            if (cookieString.length != 0) {
                ...
                if (typeof cookieMatch != "undefined" && cookieMatch != null) cookieValue = cookieMatch[1]
            }
            return cookieValue
        }
        ...
        function getFirstPartyCookieDomain(data) {
            ...
            if (typeof data !== "undefined" && data.domain && data.domain != "undefined" && data.domain != null && actualClient.cookieDomain.length > 0) {
                ...
                if (actualClient.cookieDomain == "." + domainCandidate || actualClient.cookieDomain ===
                    domainCandidate) cookieDomain = actualClient.cookieDomain;
                ...
                else if (domainCandidate.indexOf(actualClient.cookieDomain) !== -1) cookieDomain = actualClient.cookieDomain;
        ...
        function writeData(cookieArray, domainArg) {
            var cookieSuccess = writeCookies(cookieArray,
                domainArg);
        ...
        function writeLocalStorage(cookieArray, domainArg) {
            if (useLocalStorage && typeof cookieArray != "undefined" && cookieArray !=
                null) {
                var cookieCount = cookieArray.length;
                for (var i = 0; i < cookieCount; i++) {
                    var cookie = cookieArray[i];
        ...
        function getCookieProperty(cookie,
            property) {
        ...
        function setConsent(cb, c, co) {
            ...
            t.src = fpcPidAppend(getConsentPre() + "/set?c\x3d" + c + (useFPC ? "\x26fpc\x3dy" : "") + "\x26callback\x3d" + ns + ".setConsentCB\x26rand\x3d" + getRandomNumber());
            if (co.hasOwnProperty("analytics")) t.src += "\x26ca\x3d" + (co.analytics ? 1 : 0);
            if (co.hasOwnProperty("datasharing")) t.src += "\x26cds\x3d" +
                (co.datasharing ? 1 : 0);
        ...
        function getConsent(cb, c) {
            ...
            var t = document.createElement("script");
            t.type = "text/javascript";
            t.src = fpcPidAppend(getConsentPre() + "/get?c\x3d" + c + "\x26callback\x3d" +
                ns + ".getConsentCB\x26rand\x3d" + getRandomNumber());
            t.id = "_lotconsentget";
            document.body.appendChild(t)
        }
        ...
        function setConsentCB(data) {
            var scriptTag = document.getElementById("_lotconsentset");
            document.body.removeChild(scriptTag);
        ...
        function executeOptimus() {
            ...
            addTrigger({
                "act": ["oanda.com : Trading Account Type : Standard : {{#standard}}.checked"],
                location: "oanda\\.com/register/\\#/sign\\-up",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73925
            });
            addTrigger({
                "act": ["oanda.com : Trading Account Type : Premium : {{#premium}}.checked"],
                location: "oanda\\.com/register/\\#/sign\\-up",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73926
            ...
            addTrigger({
                "act": ["oanda.com : Trading  Account Address : Country : {{div.input-group.intl-tel-input div.selected-flag div}}.className"],
                location: "oanda\\.com/register/\\#/sign\\-up",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73927
            ...
            addTrigger({
                "act": ["oanda.com : Trading Account Phone : Country : {{div.standard.phone div.intl-tel-input div.selected-flag div.iti-flag}}.className"],
                location: "oanda\\.com/register/\\#/sign\\-up",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73928
            ...
            addTrigger({
                "act": ["$1 : Trading Account Citizenship : Country : {{#citizenship}}.value"],
                location: "oanda\\.com/register/\\#/sign\\-up/suitability",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73929
            });
            addTrigger({
                "act": ['$1 : Trading Account Citizen or Tax Resident in another Country : Yes : {{label input[ng-value*\x3d"true"]}}.checked'],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73930
            ...
            addTrigger({
                "act": ['$1 : Trading Account Citizen or Tax Resident in another Country : No : {{label input[ng-value*\x3d"false"]}}.checked'],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73931
            ...
            addTrigger({
                "act": ['oanda.com : Trading Account Qualifications : Yes : {{div.form-group.ng-scope div.col-sm-3.checkbox label input[ng-value*\x3d"true"]}}.checked'],
                location: "oanda\\.com/register/\\#/sign\\-up/suitability",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73932
            ...
            addTrigger({
                "act": ['oanda.com : Trading Account Qualifications : No : {{div.form-group.ng-scope div.col-sm-3.checkbox label input[ng-value*\x3d"false"]}}.checked'],
                location: "oanda\\.com/register/\\#/sign\\-up/suitability",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73933
            ...
            addTrigger({
                "act": ["$1 : Trading Account Employment Status : {{#employmentStatus}}.value"],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73934
            ...
            addTrigger({
                "act": ["$1 : Trading Account Annual Income : {{#annualIncome}}.value"],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73935
            ...
            addTrigger({
                "act": ["$1 : Trading Account Net Worth : {{#netWorth}}.value"],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73936
            ...
            addTrigger({
                "act": ["$1 : Trading Account Source of Funds : {{#incomeSourceDetails}}.value"],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73937
            ...
            addTrigger({
                "act": ['$1 : Trading Account CFDs Experience : {{select[name*\x3d"SIGN_UP.EXPERIENCE.CFDS.LABEL"]}}.value'],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73938
            ...
            addTrigger({
                "act": ['$1 : Trading Account FX Experience : {{select[name*\x3d"SIGN_UP.EXPERIENCE.FX.LABEL"]}}.value'],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73939
            ...
            addTrigger({
                "act": ['$1 : Trading Account Other Investment Products Experience : {{select[name*\x3d"SIGN_UP.EXPERIENCE.OTHER_INVESTMENT_PRODUCTS.LABEL"]}}.value'],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 73940
            ...
            addTrigger({
                "act": ['oanda.com : Demo Account Address : Country : {{div[ng-show*\x3d"showAddressForm"] div.selected-flag div}}.className'],
                location: "oanda\\.com/register/\\#/sign\\-up/demo",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73941
            });
            addTrigger({
                "act": ["oanda.com : Demo Account Phone : Country : {{div.standard.phone div.intl-tel-input div.selected-flag div.iti-flag}}.className"],
                location: "oanda\\.com/register/\\#/sign\\-up/demo",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73942
            ...
            addTrigger({
                "act": ["$1 : Demo Account Trade with fx Trade Practice : Download Now"],
                location: "\\://([^/]*)(.*)",
                element: '{{a.button.secondary.ng-scope[ng-click*\x3d"trackDemoFxTradeDownload()"]}}',
                event: "click",
                opr: 73943
            });
            addTrigger({
                "act": ["$1 : Demo Account Trade with MT4 : Download Now"],
                location: "\\://([^/]*)(.*)",
                element: '{{a.button.secondary.ng-scope[ng-click*\x3d"trackDemoMT4Download()"]}}',
                event: "click",
                opr: 73944
            });
            addTrigger({
                "act": ["oanda.com : Demo Account : Sign up"],
                location: "oanda\\.com/register/\\#/sign\\-up/demo",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73962
            ...
            addTrigger({
                "act": ["oanda.com : Trading Account : Sign up"],
                location: "oanda\\.com/register/\\#/sign\\-up",
                element: "{{button.btn-success}}",
                event: "click",
                opr: 73963
            ...
            addTrigger({
                "act": ["$1 : Open a Trading Account Clicked"],
                location: "\\://([^/]*)",
                element: "{{#cta-buttons a.btn:nth-of-type(1)}}",
                event: "click",
                opr: 74921
            });
            addTrigger({
                "act": ["$1 : Open a Demo Account Clicked"],
                location: "\\://([^/]*)",
                element: "{{#cta-buttons a.btn:nth-of-type(2)}}",
                event: "click",
                opr: 74922
            });
            addTrigger({
                "act": ['$1 : Trading Account Other Derivative Products Experience : {{select[name*\x3d"SIGN_UP.EXPERIENCE.OTHER_DERIVATIVE_PRODUCTS.LABEL"]}}.value'],
                location: "\\://([^/]*)(.*)",
                element: '{{button[ng-click*\x3d"checkForErrors()"]}}',
                event: "click",
                opr: 75364
            ...
            addTrigger({
                "int": ["Oanda : Total Site Traffic"],
                location: "oanda",
                element: "{{html}}",
                opr: 50551
            });
            addTrigger({
                "int": ["Oanda : Site Section : $1"],
                location: "oanda(?:[^/]+)/([a-zA-Z_-]+)",
                element: "{{html}}",
                opr: 50552
            });
            addTrigger({
                "int": ["Oanda : Site Section : $1 : $2"],
                location: "oanda(?:[^/]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)",
                element: "{{html}}",
                opr: 50553
            });
            addTrigger({
                "int": ["Oanda : Site Section : $1 : $2 : $3"],
                location: "oanda(?:[^/]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)",
                element: "{{html}}",
                opr: 50555
            });
            addTrigger({
                "int": ["Oanda : Site Section : $1 : $2 : $3 : $4"],
                location: "oanda(?:[^/]+)/([a-zA-Z_-]+)/([a-zA-Z#_-]+)/([a-zA-Z_-]+)/([a-zA-Z0-9_+%#?\x3d\u0080-\uffff-]+)",
                element: "{{html}}",
                opr: 50556
            });
            addTrigger({
                "int": ["Oanda : $1 : $2"],
                location: "([a-zA-Z]+)\\.oanda\\.([a-zA-Z.]+)/",
                element: "{{html}}",
                opr: 63057
            });
            addTrigger({
                "int": ["Oanda : Site Section : $1 : $2 : $3 : $4 : $5"],
                location: "oanda(?:[^/]+)/([a-zA-Z_-]+)/([a-zA-Z#_-]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)/([a-zA-Z0-9_+%#?\x3d\u0080-\uffff-]+)",
                element: "{{html}}",
                opr: 75367
            });
            addTrigger({
                "int": ["marketpulse.com : Total Site Traffic"],
                location: "marketpulse\\.com",
                element: "{{html}}",
                event: "",
                opr: 76355
            });
            addTrigger({
                "int": ["marketpulse.com : Site Section : $1"],
                location: "marketpulse\\.com/([a-zA-Z_-]+)",
                element: "{{html}}",
                event: "",
                opr: 76356
            });
            addTrigger({
                "int": ["marketpulse.com : Site Section : $1 : $2"],
                location: "marketpulse\\.com/([a-zA-Z_-]+)/([a-zA-Z0-9_-]+)",
                element: "{{html}}",
                event: "",
                opr: 76357
            });
            addTrigger({
                "int": ["oanda.com : Site Section : register : # : sign-up : demo : thank-you"],
                location: "oanda\\.com/register/\\#/sign\\-up/demo/thank\\-you",
                element: "{{html}}",
                event: "",
                opr: 76778
            });
            addTrigger({
                "int": ["oanda.com : Site Section : register : # : sign-up : demo : thank-you"],
                location: "oanda\\.com/register/\\#/sign\\-up/id/thank\\-you(.*)",
                element: "{{html}}",
                event: "",
                opr: 76779
            });
            addTrigger({
                "srch": ["Oanda : Search Term : $1"],
                location: "oanda(?:[^/]+)/search(.*)q\\\x3d([a-zA-Z0-9_-]+)",
                element: "{{html}}",
                opr: 50554
            });
            addTrigger({
                "dmn": ["$1 : Referral Site : r{{://([^/]*)([/])}}.1"],
                location: "\\://([^/]*)([/])",
                element: "r{{://([^/]*)([/])}}.1",
                opr: 76438
            });
            addTrigger({
                "srch": ["Search Engine Keyword : r{{(p\x3d|q\x3d)([^\x26]*)([\x26])}}.2"],
                location: "(.*)",
                element: "r{{(google|bing|yahoo|ask|aol)(.*)(p\x3d|q\x3d)}}",
                opr: 34588
            });
            bindTriggers();
